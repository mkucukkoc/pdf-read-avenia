...
from endpoints.styles import aesthetic_router as styles_aesthetic_router
from endpoints.styles import family_router as styles_family_router
...
app.include_router(styles_aesthetic_router)
app.include_router(styles_family_router)
