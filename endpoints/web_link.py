...
def _enqueue_usage_event(
    ...
    *,
    ...
    try:
        ...
        logger.warning("Usage tracking failed for web_link", exc_info=True)
...
async def run_web_link(payload: WebSearchRequest, user_id: str, request: Optional[Request] = None) -> Dict[str, Any]:
