...
DEFAULT_CAR_PROMPTS = {
    "bmw": "Alp dag yolu, {weather} hava durumunda, arabanin direksiyon koltugunda oturan kisiyi arka koltuktan ve hafif yukaridan cekin; cinematic lighting, net detay.",
    "mercedes": "Paris gece sokagi, {weather} hava durumunda, kapisi acik mercedes icinde oturan kisiyi yandan cekin; luxury editorial, soft bokeh.",
    "audi": "Tokyo modern cadde, {weather} hava durumunda, kokpit icinden karsi aci portre; neon yansimalar, sinematik.",
    "porsche": "Monaco sahil yolu, {weather} hava durumunda, arabaya yaslanmis kisiyi 3/4 acidan cekin; premium lifestyle.",
    "ferrari": "Monza pist kenari, {weather} hava durumunda, direksiyon basinda atletik poz; dramatic rim light.",
    "lamborghini": "Dubai gece skyline, {weather} hava durumunda, kapisi yukari acik lambo yaninda guclu poz; high contrast.",
    "rolls_royce": "Londra klasik bina onunde, {weather} hava durumunda, arka koltukta oturan kisiyi arkadan cekin; royal luxury.",
    "bentley": "Venedik dar sokak, {weather} hava durumunda, arabadan inen kisiyi tam boy cekin; elegant editorial.",
    "tesla": "Norvec fiyordu, {weather} hava durumunda, minimalist ic mekanda direksiyon basinda kisi; temiz kompozisyon.",
    "land_rover": "Iskocya yaylalari offroad, {weather} hava durumunda, SUV yaninda dis mekanda kisi; rugged cinematic.",
...
DEFAULT_WEATHER_STYLES = {
    "sunny": "bright natural sunlight, golden hour, clear sky, high contrast",
    "rainy": "raindrops on windows, moody atmosphere, wet asphalt, overcast, water reflections",
    "snowy": "snow-covered road, soft white lighting, cold blue tones, frost on window edges",
    "foggy": "dense white fog, mystical atmosphere, blurred background, soft diffused lighting, low visibility",
    "stormy": "dark thunderclouds, dramatic lightning flashes in distance, heavy wind effect, aggressive gray tones",
    "sunset": "warm orange and purple hues, long shadows, lens flare, intense golden glow on faces",
    "night_city": "city street lights, neon signs reflecting on dashboard, bokeh city lights background, sharp night contrast",
    "overcast": "soft even lighting, no harsh shadows, realistic flat tones, moody gray sky",
    "sandstorm": "dusty orange atmosphere, hazy desert road, warm sepia tones, cinematic grainy texture",
    "dawn": "early morning soft blue light, thin mist over the road, pale pink horizon, calm and serene vibe",
}
